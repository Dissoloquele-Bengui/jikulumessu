...
@section('titulo', 'Listar Proprietários')
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">{{ __('Editar Proprietário') }}</h4>
...
<div class="text-left modal fade" id="ModalCreate" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ __('Adicionar Proprietário') }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
@if (session('user.purge.success'))
    <script>
        Swal.fire(
            'Proprietário Purgado com sucesso!',
            '',
            'success'
        )
    </script>
...
@if (session('user.update.error'))
    <script>
        Swal.fire(
            'Erro ao Actualizar Proprietário!',
            '',
            'error'
        )
    </script>
